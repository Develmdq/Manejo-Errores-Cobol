      ...
      * CONTROL FILES STATUS SALIDA *                                   
       01 WS-CODE-SAL        PIC X(2).                                  
          88 WS-FSS-OK                     VALUE '00'.                  
          88 WS-FSS-NOK                    VALUE '01' THRU '99'.        
                                                                        
      * CONTROL FINAL PROGRAMA *                                        
       01 WS-FINAL-PGM       PIC X(2).                                  
          88 WS-PGM-OK                     VALUE '00'.                  
          88 WS-PGM-FIN                    VALUE '01'.                  
                                                                        
      * CONTROL DE ESTADO SEGUN ACCION A REALIZAR EN DB/PS *            
       01 WS-ACCION          PIC X(20).                                 
          88 WS-OPEN-CURSOR                VALUE 'ERROR OPEN  CURSOR: '.
          88 WS-FETCH-CURSOR               VALUE 'ERROR FETCH CURSOR: '.
          88 WS-CLOSE-CURSOR               VALUE 'ERROR CLOSE CURSOR: '.
          88 WS-OPEN-SFILE                 VALUE 'ERROR OPEN  SFILE : '.
          88 WS-WRITE-SFILE                VALUE 'ERROR WRITE SFILE : '.
          88 WS-CLOSE-SFILE                VALUE 'ERROR CLOSE SFILE : '.
                                                                        
      * CONTROL DE ESTADO SEGUN LINEA A IMPRIMIR *                      
       01 WS-LINEAS          PIC 9.                                     
