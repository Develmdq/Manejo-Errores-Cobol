...
//           GOPGM=PGMRDC61
//PC.SYSLIB  DD DSN=&SYSUID..CURSOS.DCLGEN,DISP=SHR
//COB.SYSLIB DD DSN=&SYSUID..ALU9999.COPYLIB,DISP=SHR
//           DD DSN=&SYSUID..CURSOS.COPYLIB,DISP=SHR
//*
//*-------------------------------------------------------
//* STEP2 - BIND DB2
//*-------------------------------------------------------
...
//DBRMLIB  DD DSN=KC03C61.CURSOS.DBRMLIB,DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN  DD *
  DSN SYSTEM(DBDG)
